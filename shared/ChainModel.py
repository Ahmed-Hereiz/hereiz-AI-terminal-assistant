...
class ChainBasicModel:
    ...
    def __repr__(self) -> str:
        """
        Returns a string representation of the ChainBasicModel instance.
        """
        return (
    ...
    def __str__(self) -> str:
        """
        Returns a user-friendly string representation of the ChainBasicModel instance.
        """
        return (
            f"ChainBasicModel using model '{self._llm.model}' with temperature "
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        """
        if isinstance(other, ChainBasicModel):
            return (
